                    ...
                    <div className="rpt-content rpt-printable">
                        ...
                        {!loading && !error && (
                            <div className="rc-detail-table-wrap rpt-table-wrap">
                                <table className="rc-detail-table rpt-table" style={{ tableLayout: "fixed" }}>
                                    <colgroup>
                                        <col style={{ width: "4%" }} />
                                        <col style={{ width: "8%" }} />
                                        <col style={{ width: "12%" }} />
                                    ...
                                    <tbody>
                                            ...
                                            grouped.forEach(({ label, rows: gRows }, gi) => {
                                                ...
                                                rendered.push(
                                                    <tr key={`grp-${gi}`} className="rpt-date-group-row">
                                                        ...
                                                        <td className="rpt-group-qty">{groupQty.toLocaleString("vi-VN")}</td>
                                                        <td />
                                                    </tr>
                                                );
                                                gRows.forEach(({ receipt: r, detail: d }, ri) => {
                                                    ...
                                                    rendered.push(
                                                        <tr key={`${r.id}-${d?.id || ri}-${gi}`}>
                                                            ...
                                                            <td style={{ whiteSpace: "nowrap" }}>{formatDate(r.docDate)}</td>
                                                            <td style={{ fontWeight: 600, color: "#1E854A", whiteSpace: "nowrap" }}>{r.docno}</td>
                                                            ...
                                                            <td style={{ textAlign: "right" }}>{formatMoney(amt)}</td>
                                                        </tr>
                                                    );
                                                });
                                            });
                                        ...
                                        {filteredRows.length > 0 && (
                                            <tr className="rpt-total-row">
                                                ...
                                                <td style={{ textAlign: "right" }}>{totalQty.toLocaleString("vi-VN")}</td>
                                                <td style={{ textAlign: "right" }}>{formatMoney(totalAmount)}</td>
                                            </tr>
                                        )}
                                    </tbody>
                                </table>
